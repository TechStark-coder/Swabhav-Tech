...
public class Messages {
	...
	/**
	 * This method will display the main menu (top level menu) on standard output
	 * (terminal) to display all options for user selection.
	 * 
	 * @param incompleteTaskCount takes the number of incomplete tasks (int) to show
	 *                            in main menu
	 * @param completedTaskCount  takes the number of complete tasks (int) to show
	 *                            in main menu
	 */
	public static void mainMenu(int incompleteTaskCount, int completedTaskCount) {
		...
		System.out.println("===========\n");
		System.out.println(
				"You have " + Messages.RED_TEXT + incompleteTaskCount + " task(s) todo " + Messages.RESET_TEXT + " and "
						+ Messages.GREEN_TEXT + completedTaskCount + " completed task(s)\n" + Messages.RESET_TEXT);
	...
	/**
	 * This method displays the menu to standard output (terminal) to show the
	 * options to display all tasks for user selection
	 */
	public static void listAllTasksMenu() {
		System.out.println("\nDisplay All Tasks");
		System.out.println("===================\n");
		System.out.println("Pick an option:");
		System.out.println("(1) Show Task List by date" + Messages.RED_TEXT + " [default choice, just press ENTER key]"
				+ Messages.RESET_TEXT);
	...
	public static void editTaskMenu() {
		...
		System.out.println("(4) Return to main menu " + Messages.RED_TEXT + " [default choice, just press ENTER]"
				+ Messages.RESET_TEXT);
	...
	/**
	 * This method will display the error message if a user input an option which is
	 * not from the choices given in main menu
	 */
	...
	/**
	 * This message will display any given message in RED or GREEN text on standard
	 * output (terminal)
	 * 
	 * @param message a text message as String
	 * @param warning a boolean value, true for printing warning with RED text, and
	 *                false for printing message in GREEN text on standard output
	 *                (terminal)
	 */
	...
	/**
	 * This message will print the given character on standard output (terminal) to
