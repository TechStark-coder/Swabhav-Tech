...
/**
 * This is a model class and it represents a Task object and it contains
 * necessary fields and methods to operate on task object.
 *
 * @author Imtiaz
 * @version 1.0
 * @since 2019-10-11
...
public class Task implements Serializable {
	...
	// A String that holds the name of project associated with task, and it could be
	// an empty string.
	 ...
	 * 
	 * @param title   A String that holds the title of a task and it cannot be empty
	 *                or null.
	 * @param project A String that holds the name of project associated with task,
	 *                and it could be an empty string.
	 ...
	 * 
	 * @return true: if the task is marked as completed, otherwise it will return
	 *         false
	 */
	...
	/**
	 * A method to get the task data as formatted string to display in multiple
	 * lines
	 * 
