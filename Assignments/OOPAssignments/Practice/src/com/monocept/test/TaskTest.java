...
/**
 * This class is created for unit testing for model class, i.e., Task
 * (Task.java)
 *
 * @author Imtiaz
 * @version 1.0
...
public class TaskTest {
	...
	/**
	 * This method will execute before executing any Test. This method will
	 * initialize the task object with vaid test parameters.
	 * 
	 * @throws Exception
	 */
	@Before
	...
	/**
	 * This method will validate the task.setTitle() method for an empty string ""
	 * as invalid parameter which should result as NullPointerException
	 */
	@Test
	...
	/**
	 * This method will validate the task.setTitle() method for trimming an empty
	 * string " " as invalid parameter which should result as NullPointerException
	 */
	@Test
	...
	/**
	 * This method will validate the task.setTitle() method for null as invalid
	 * parameter which should result as NullPointerException
	 */
	@Test
	...
	/**
	 * This method will validate the task.setProject() method for empty string "" as
	 * parameter And it will also test the task.getProject Project title is allowed
	 * be empty
	 */
	@Test
	...
	/**
	 * This method will validate the task.setDueDate() method with a wrong format
	 * date as parameter
	 */
	@Test
